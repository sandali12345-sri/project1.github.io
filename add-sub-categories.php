                           ...
                           <div class="card-body">
                              <form action="functions.php" method="post">
                                 <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                       <label class="form-label" for="inputName">Categories Name</label>
                                       <label for="name"> <span style="color:red;">*</span></label>
                                       <input type="text" class="form-control" name="cat_name" id="inputEmail4" placeholder="Name" required>
                                </div>
                                <div class="col-md-6">
                                       <label class="form-label" for="inputTitle">Meta Title</label>
                                       <label for="Title"> <span style="color:red;">*</span></label>
                                       <input type="text" class="form-control"name="meta_title" id="inputEmail4" placeholder="title"required>
                                </div>
                                <div class="col-md-6 mb-3">
                                       <label class="form-label" for="inputKey">Meta Keyword</label>
                                       <label for="inputKey"><span style="color:red;">*</span></label>
                                       <input type="text" class="form-control"name="meta_key" id="inputEmail4" placeholder="Keyword"required>
                                </div>
                                <div class="col-md-6 mb-3">
                                       <label class="form-label" for="inputDesc">Meta Description</label>
                                       <label for="inputDesc"> <span style="color:red;">*</span></label>
                                       <input type="text" class="form-control" name="meta_desc" id="inputEmail4" placeholder="Description"required>
                                </div>
                                <div class="col-md-6 mb-3">
